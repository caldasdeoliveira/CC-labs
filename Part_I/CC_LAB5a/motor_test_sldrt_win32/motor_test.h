...
#define motor_test_rtModel             RT_MODEL_motor_test_T

/* Block signals (auto storage) */
typedef struct {
  real_T Output;                       /* '<S1>/Output' */
  real_T AnalogInput[2];               /* '<Root>/Analog Input' */
} B_motor_test_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Tensao_Pot_PWORK;                  /* '<Root>/Tensao_Pot' */
...
#define rtB                            motor_test_B
#define BlockIO                        B_motor_test_T
#define rtP                            motor_test_P
#define Parameters                     P_motor_test_T
#define rtDWork                        motor_test_DW
#define D_Work                         DW_motor_test_T
...
extern void motor_test_output(void);
extern void motor_test_update(void);
extern void motor_test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motor_test_rtModel *motor_test(void);
